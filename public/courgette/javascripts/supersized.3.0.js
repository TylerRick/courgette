			...
			if (options.slideshow == 1){
				...
				if (options.navigation == 1){ //Skip if no navigation
				    ...
				    $('#nextslide').mousedown(function() {
					   	$(this).attr("src", "/courgette/images/forward.png");
					});
					$('#nextslide').mouseup(function() {
					    $(this).attr("src", "/courgette/images/forward_dull.png");
					});
					...
					$('#prevslide').mousedown(function() {
					    $(this).attr("src", "/courgette/images/back.png");
					});
					$('#prevslide').mouseup(function() {
					    $(this).attr("src", "/courgette/images/back_dull.png");
					});
				    ...
				    $('#pauseplay').click(function() {
				    	if($.inAnimation) return false;
				    	var src = ($(this).attr("src") === "/courgette/images/play.png") ? "/courgette/images/pause.png" : "/courgette/images/play.png";
      					if (src == "/courgette/images/pause.png"){
      						$(this).attr("src", "/courgette/images/play.png");
      						$.paused = false;
					        slideshow_interval = setInterval(nextslide, options.slide_interval);  
				        }else{
				        	$(this).attr("src", "/courgette/images/pause.png");
				        	clearInterval(slideshow_interval);
				        	$.paused = true;
				        }
      					$(this).attr("src", src);
				    ...
				    $('#pauseplay').mouseover(function() {
				    	var imagecheck = ($(this).attr("src") === "/courgette/images/play_dull.png");
				    	if (imagecheck){
      						$(this).attr("src", "/courgette/images/play.png"); 
				        }else{
				        	$(this).attr("src", "/courgette/images/pause.png");
				    ...
				    $('#pauseplay').mouseout(function() {
				    	var imagecheck = ($(this).attr("src") === "/courgette/images/play.png");
				    	if (imagecheck){
      						$(this).attr("src", "/courgette/images/play_dull.png"); 
				        }else{
				        	$(this).attr("src", "/courgette/images/pause_dull.png");
				        }
				        return false;
				    });
				}
		...
		$('#supersized').hover(function() {
	   		if (options.slideshow == 1 && options.pause_hover == 1){
	   			if(!($.paused) && options.navigation == 1){
	   				$('#pauseplay').attr("src", "/courgette/images/pause.png"); 
	   				clearInterval(slideshow_interval);
	   			}
	   		}
			...
			if (options.slideshow == 1 && options.pause_hover == 1){
				if(!($.paused) && options.navigation == 1){
					$('#pauseplay').attr("src", "/courgette/images/pause_dull.png");
					slideshow_interval = setInterval(nextslide, options.slide_interval);
				} 
			}
